<?php
$this->breadcrumbs[] = Yii::t('dbrisinajumi.fcrn','Fcrt Currency Rates');
...
<h1>
    <?php echo Yii::t('dbrisinajumi.fcrn', 'Fcrt Currency Rates'); ?> <small><?php echo Yii::t('dbrisinajumi.fcrn', 'Manage'); ?></small>
</h1>
